...
public class Video implements Comparable<Video>
{
	...
	public Video(String film, int n) throws IllegalArgumentException 
	{
		if(n<=0)
		{
			throw new IllegalArgumentException("No copies of movie");
		}
		this.film = film;
		numCopies = n;
	}
	...
	public void addNumCopies(int n) throws IllegalArgumentException
	{
		if(n<=0)
		{
			throw new IllegalArgumentException("No copies of movie added");
		}
    ...
    public void rentCopies(int n) throws IllegalArgumentException, AllCopiesRentedOutException
    {
    	if(n<=0)
		{
			throw new IllegalArgumentException("No copies of movie rented");
		}
    	if(numRentedCopies == numCopies)
    	{
    		throw new AllCopiesRentedOutException("Film "+getFilm()+" has been rented out");
    	}
    	...
    	{
    		numRentedCopies = n + numRentedCopies;
    	}
    }
    ...
    public void returnCopies(int n) throws IllegalArgumentException
    {
    	if(n<=0)
		{
			throw new IllegalArgumentException("No copies of movie returned");
		}
	...
	{
		if(this.film.compareToIgnoreCase(vd.film)>0)
		{
			return 1;
		}
		else if(this.film.compareToIgnoreCase(vd.film)<0)
		{
			return -1;
		}
		else
